...
/* FCB-EW9500H: Video Standard */
#define EW9500H_REGISTER_DIGITAL_OUTPUT                  0x60
  #define EW9500H_REGISTER_DIGITAL_OUTPUT_HDMI_YUV       0x00 //initial (reset required)
  #define EW9500H_REGISTER_DIGITAL_OUTPUT_HDMI_RGB       0x01
  #define EW9500H_REGISTER_DIGITAL_OUTPUT_DVI_RGB        0x02

#define EW9500H_REGISTER_VIDEO_SIGNAL         0x72
  #define EW9500H_REGISTER_VIDEO_1080I_59     0x01
  #define EW9500H_REGISTER_VIDEO_1080I_60     0x02
  #define EW9500H_REGISTER_VIDEO_1080I_50     0x04
  #define EW9500H_REGISTER_VIDEO_1080P_29     0x06
  #define EW9500H_REGISTER_VIDEO_1080P_30     0x07
  #define EW9500H_REGISTER_VIDEO_1080P_25     0x08
  #define EW9500H_REGISTER_VIDEO_720P_59      0x09
  #define EW9500H_REGISTER_VIDEO_720P_60      0x0A
  #define EW9500H_REGISTER_VIDEO_720P_50      0x0C
  #define EW9500H_REGISTER_VIDEO_720P_29      0x0E
  #define EW9500H_REGISTER_VIDEO_720P_30      0x0F
  #define EW9500H_REGISTER_VIDEO_720P_25      0x11
  #define EW9500H_REGISTER_VIDEO_1080P_59     0x13
  #define EW9500H_REGISTER_VIDEO_1080P_50     0x14
  #define EW9500H_REGISTER_VIDEO_1080P_60     0x15
  #define EW9500H_REGISTER_VIDEO_480P_60      0x1A  //test mode
  #define EW9500H_REGISTER_VIDEO_480P_59      0x1B  //test mode
  #define EW9500H_REGISTER_VIDEO_576P_50      0x1C  //test mode
  #define EW9500H_REGISTER_VIDEO_2160P_60     0x25  //output 2688 x 1512
  #define EW9500H_REGISTER_VIDEO_2160P_60_XL  0x26  //2688x1512 adds black frame on periphery
  #define EW9500H_REGISTER_VIDEO_2160P_50     0x27
  #define EW9500H_REGISTER_VIDEO_2160P_30     0x28  //2688x1512 adds black frame on periphery
  #define EW9500H_REGISTER_VIDEO_2160P_29     0x29  //2688x1512 adds black frame on periphery
  #define EW9500H_REGISTER_VIDEO_2160P_25     0x2A  //2688x1512 adds black frame on periphery
  #define EW9500H_REGISTER_VIDEO_2160P_30_XL  0x2B  //2560x1440 adds black frame
  #define EW9500H_REGISTER_VIDEO_2160P_25_XL  0x2C  //2560x1440 adds black frame
